...
# Run from the repository root, e.g. Rscript experiments/experiment-3/COI_Exp3.R.
...
# load data
data_COI = read.csv('experiments/experiment-3/data_COI_Exp3.csv')
...
# 2.3.2.3 simple effect of COI when results favour the new drug ----------------
...
# 2.3.2.4 simple effect of COI when results speak against the new drug ----------------
...
# 2.4 Trust in the company that developed the new drug ----------------------
...
# 2.4.2.3 simple effect of COI when results favour the new drug ----------------
...
# 2.4.2.4 simple effect of COI when results speak against the new drug ----------------
...
# 2.5.2.3 simple effect of COI when results favour the new drug ----------------
